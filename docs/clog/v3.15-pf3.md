I guess it's time to have new release, mates, and I'm glad to introduce 3.15-pf3.  
  
Besides having lots of stable fixes this release introduces official -ck1 patch with BFS updated to v449 and patched using Alfred's patches.  
  
You may grab the patch right [here](https://pf.natalenko.name/sources/3.15/patch-3.15-pf3.xz).  
