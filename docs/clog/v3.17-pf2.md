Kudos to all autumn cacao fans (like me right now). I'd like to introduce another pf-kernel update — v3.17-pf2.  
  
This release incorporates huge bunch of stable patches, official -ck release and updated UKSM. Still no TOI, but Nigel told us he was almost ready to release it.  
  
So grab [the patch](https://pf.natalenko.name/sources/3.17/patch-3.17-pf2.xz) and test it.  
