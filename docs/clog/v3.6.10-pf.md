Hi everyone. New pf-kernel release is out, so you may grab [the patch](http://pf.natalenko.name/sources/3.6/patch-3.6.10-pf.bz2) and start compiling it right now.  
