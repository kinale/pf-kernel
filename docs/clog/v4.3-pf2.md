Another [pf-kernel update](https://pf.natalenko.name/sources/4.3/patch-4.3-pf2.xz) features enhanced BFS from Alfred Chen (-vrq branch, v4.3_0465_2_vrq1) as well as stable update (v4.3.2).  
  
Official Arch Linux packages for Intel Ivy Bridge and AMD Jaguar architectures are tested by me and said to be usable. To use them add the following declaration in your /etc/pacman.conf:  
...
Install linux-pf-[ivybridge|jaguar] and linux-pf-headers-[ivybridge|jaguar] packages.  
