In response to Christos Nouskas request for updated pf-kernel against LTS Linux branch, I've decided to release new 3.14-pfX, and [here is 3.14-pf5](https://pf.natalenko.name/sources/3.14/patch-3.14-pf5.xz).  
