Another pf-kernel release is here. You may grab this lovely patch [here](http://pf.natalenko.name/sources/3.6/patch-3.6.3-pf.bz2) and start compiling right now.  
  
This release introduces two important updates. First is merging official -ck release with BFSv425. Second is updating UKSM to v0.1.2.1 that should fix timing and hibernation issues.  
