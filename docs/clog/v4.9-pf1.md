I'm glad to announce the immediate availability of new pf-kernel release for fresh Linux kernel. Please grab the patch [here](https://pf.natalenko.name/sources/4.9/patch-4.9-pf1.xz). As usual: 
