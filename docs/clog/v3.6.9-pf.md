Another stable kernel release — another pf-kernel release. Please grab [this patch](http://pf.natalenko.name/sources/3.6/patch-3.6.9-pf.bz2) and start compiling right now.  
