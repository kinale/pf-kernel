[This patch](http://pf.natalenko.name/sources/3.6/patch-3.6.7-pf.bz2) introduces new pf-kernel release, so grab it and compile, especially if you've got ext4 on your hdd/ssd.  
