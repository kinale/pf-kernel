New kernel is here. Grab [the patch](http://pf.natalenko.name/sources/3.6/patch-3.6.6-pf.bz2) immediately and load your CPUs with multiple gcc tasks right now.  
