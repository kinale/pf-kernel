Another step in 3.9 tree stabilization is done — 3.9.4-pf is out. It incorporates 3.9.5 stable patch as well as small PKGBUILD and config fixes from me.  
  
Please read the shortlog below and grab the [patch](http://pf.natalenko.name/sources/3.9/patch-3.9.4-pf.bz2) immediately.  
