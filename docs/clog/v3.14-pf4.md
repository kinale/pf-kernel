Well, it's couple of hours before 3.15 release, and here is (hopefully) last pf-kernel for 3.14 Linux branch — 3.14-pf4.  
  
You may grab the patch via [usual link](https://pf.natalenko.name/sources/3.14/patch-3.14-pf4.xz) and apply it right now.  
  
Nothing exciting, in fact. This release is based on top of fresh and stable 3.14.6 kernel, so think of it as of trivial resync.  
