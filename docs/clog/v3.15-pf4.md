Another resync against stable tree is here, and now 3.15-pf4 is based on top of 3.15.6. There are lots of small but important fixes and one weak attempt to fix BFS+ath9k issue with no success (still investigating it).  
  
I expect this release to be pre-last or pre-pre-last for 3.15 series as 3.16 release is approaching.  
  
You may grab the patch [here](https://pf.natalenko.name/sources/3.15/patch-3.15-pf4.xz).  
