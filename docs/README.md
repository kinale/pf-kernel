...
Latest release is: [v4.14-pf5](https://github.com/pfactum/pf-kernel/releases/latest), [patch](https://github.com/pfactum/pf-kernel/compare/v4.14...v4.14-pf5.diff) (_applies to bare kernel only with **no stable patches**_)
