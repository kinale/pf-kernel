...
Latest release is: [v4.13-pf10](https://github.com/pfactum/pf-kernel/releases/latest), [patch](https://github.com/pfactum/pf-kernel/compare/v4.13...v4.13-pf10.diff) (_applies to bare kernel only with **no stable patches**_)
