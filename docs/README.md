...
Latest release is: [v4.15-pf4](https://github.com/pfactum/pf-kernel/releases/latest), [patch](https://github.com/pfactum/pf-kernel/compare/v4.15...v4.15-pf4.diff) (_applies to bare kernel only with **no stable patches**_)
